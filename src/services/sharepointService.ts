...
export class SharePointService {
  ...
  private static normalizeVisitatoreItem(item: any) {
    ...
    const normalizedFields = {
      ...
      Telefono: getValue("Telefono", "field_4", "Phone"),
      Azienda: getValue("Azienda", "field_5", "Company"),
      Stato: getValue("Stato", "field_6", "Status"),
      Categoria: getValue("Categoria", "field_7", "Category"),
